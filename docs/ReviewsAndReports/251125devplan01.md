...
- [ ] Step 2 — Registry cleanup & discovery telemetry
- [ ] Step 3 — Tool definitions in upstream payloads & tool-call routing
- [ ] Step 4 — Real streaming passthrough (declarative + SDK)
- [ ] Step 5 — SDK adapter upgrades (context, async, gateway tools)
- [ ] Step 6 — Metrics/admin expansion for tools & discovery
- [ ] Step 7 — Watch-mode coverage & security pattern alignment
